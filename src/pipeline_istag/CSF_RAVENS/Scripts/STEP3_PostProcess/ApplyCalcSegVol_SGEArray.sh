...
## Run script
inImg=${imgDir}/${SUB}/${SUB}_T1_LPS_dlicv_seg.nii.gz
outCsv=${imgDir}/${SUB}/${SUB}_T1_LPS_dlicv_seg_Vol.csv

${scr} $SUB $inImg ${outCsv} > ${outDir}/${SUB}/sgelogs/ApplyCalcSegVol.sh-${JOB_ID}-${SGE_TASK_ID}.log 2>&1;
