...
. /cbica/projects/OASIS/OASIS3/Pipelines/OASIS3_DLICV_2022/Scripts/STEP4_CSF-RAVENS/BashUtilityFunctions.sh || { echo "Failed to source BashUtilityFunctions.sh!" 1>&2; exit 1; }
